...
class FamilyEdit extends StatelessWidget {
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    makeInput(label: "Dependent Name :               "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    ...
                    makeInput(label: "Occupation :                         "),
                    Padding(
                      padding: EdgeInsets.all(20.0),
                    ),
                    makeInput2(label: "Communication Address : "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    const Divider(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text(
                                    "Add/Change", textAlign: TextAlign.center,
                                    style: TextStyle(

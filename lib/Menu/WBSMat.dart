...
class WBSMat extends StatelessWidget {
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text("Request: WBS Material",textAlign: TextAlign.center, style: TextStyle(
                            ...
                            child: InkWell(
                              onTap: (){
                                Fluttertoast.showToast(
                                  msg: "You have successfully raised WBS Material Request.",

...
class PFBalance extends StatelessWidget {
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text("PF Contribution", style: TextStyle(
                        fontSize: 15,
                    ...
                    makeInput(label: "Employee Contribution :      "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput(label: "Employee Contribution :      "),
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 20, right: 20),
                      child: Text("Note: Displayed Contribution is for reference only", style: TextStyle(
                        fontSize: 14,
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 20, right: 20),
                      child: Text("For your actual contribution, Contact Hr Staff.", style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w500,
                        color: Colors.black, fontFamily: 'jost',
                      ),),

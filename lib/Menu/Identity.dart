                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text("Identity Details", style: TextStyle(
                        fontSize: 15,
                    ...
                    makeInput(label: "Aadhar No. :               "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput(label: "Pan Card No. :           "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput(label: "Election Card No. :    "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput(label: "UAN :                           "),
...
class Identity2 extends StatelessWidget {

            ...
            Expanded(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text("Company Information",textAlign: TextAlign.center, style: TextStyle(
              ...
              Container(
                  ...
                  child: Image(
                    ...
                    makeInput2(label: 'Company Name :                  '),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),

                    makeInput2(label: 'Sales Contact Person :        '),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    ...
                    makeInput2(label: 'Contact email address :      '),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),

...
class ReqTraining extends StatelessWidget {
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text("Training Required",textAlign: TextAlign.center, style: TextStyle(
                    ...
                    makeInput2(label: 'Type of Training :                 '),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput(label: 'Reason for Training'),
                            ...
                            child: InkWell(
                              onTap: (){
                                Fluttertoast.showToast(
                                  msg: "You have successfully requested new Training for you.",

...
class LoanReq extends StatelessWidget {
                ...
                child: Column(
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text("Loan Request", style: TextStyle(
                        fontSize: 15,
                      ...
                      child: Table(
                          ...
                          children: [
                            TableRow(children :[
                              ...
                              Padding(
                                padding: EdgeInsets.only(top: 20, bottom: 20, right: 5, left: 15),
                                child: Center(child: Text('Reason for loan',style: TextStyle(fontFamily: 'jost',color: Colors.black, fontSize: 14,fontWeight: FontWeight.w700),),),
                              ),
                              Padding(
                                padding: EdgeInsets.only(top: 20, bottom: 20, right: 10, left: 20),
                                child: Center(child: Text('Req. Amt.',style: TextStyle(fontFamily: 'jost',color: Colors.black, fontSize: 14,fontWeight: FontWeight.w700),),),
                              ),
                              Padding(
                                padding: EdgeInsets.only(top: 20, bottom: 20, right: 5, left: 15),
                                child: Center(child: Text('Approved Tag',style: TextStyle(fontFamily: 'jost',color: Colors.black, fontSize: 14,fontWeight: FontWeight.w700),),),
                              ),
                              Padding(
                                padding: EdgeInsets.only(top: 20, bottom: 20, right: 5, left: 15),
                                child: Center(child: Text('Disbursement date',style: TextStyle(fontFamily: 'jost',color: Colors.black, fontSize: 14,fontWeight: FontWeight.w700),),),
                              ),
                              Padding(
                                padding: EdgeInsets.only(top: 20, bottom: 20, right: 5, left: 15),
                                child: Center(child: Text('Settle Months',style: TextStyle(fontFamily: 'jost',color: Colors.black, fontSize: 14,fontWeight: FontWeight.w700),),),
                              ),
                            ]),
                            TableRow(children :[
                              Padding(

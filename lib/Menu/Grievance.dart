                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text("Grievance",textAlign: TextAlign.center, style: TextStyle(
                    ...
                    makeInput2(label: 'Department :                         '),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),

                    makeInput2(label: 'Name of Person :                 '),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput(label: 'Grievance Details'),
                            ...
                            child: InkWell(
                              onTap: (){
                                Fluttertoast.showToast(
                                  msg: "You have successfully Grievance Report.",
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text("Report Grievance",textAlign: TextAlign.center, style: TextStyle(

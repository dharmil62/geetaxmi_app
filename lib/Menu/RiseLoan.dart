...
class RiseLoan extends StatelessWidget {
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text("Loan Request",textAlign: TextAlign.center, style: TextStyle(
                    ...
                    makeInput2(label: 'Loan Amount :                      '),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput2(label: 'Repay in Months :                '),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput(label: 'Reason for Loan'),
                    Padding(
                            ...
                            child: InkWell(
                              onTap: (){
                                Fluttertoast.showToast(
                                  msg: "You have successfully applied for loan.",
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text("Request Loan",textAlign: TextAlign.center, style: TextStyle(

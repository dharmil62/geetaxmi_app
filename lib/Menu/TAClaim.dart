...
class TAClaim extends StatelessWidget {
                ...
                child: Column(
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text("TA/DA Claim", style: TextStyle(
                        fontSize: 15,
                          ...
                          children: [
                            TableRow(children :[
                              Padding(
                                ...
                                child: Center(child: Text('Type of Expense',style: TextStyle(fontFamily: 'jost',color: Colors.black, fontSize: 14,fontWeight: FontWeight.w700),),),
                              ),
                              Padding(
                                padding: EdgeInsets.only(top: 20, bottom: 20, right: 5, left: 15),
                                child: Center(child: Text('Expense Amt.',style: TextStyle(fontFamily: 'jost',color: Colors.black, fontSize: 14,fontWeight: FontWeight.w700),),),
                              ),
                              Padding(
                                padding: EdgeInsets.only(top: 20, bottom: 20, right: 10, left: 20),
                                child: Center(child: Text('Expense Date',style: TextStyle(fontFamily: 'jost',color: Colors.black, fontSize: 14,fontWeight: FontWeight.w700),),),
                              ),
                              Padding(
                                padding: EdgeInsets.only(top: 20, bottom: 20, right: 5, left: 15),
                              ...
                              Padding(
                                padding: EdgeInsets.only(top: 20, bottom: 20, right: 5, left: 15),
                                child: Center(child: Text('Disburse date',style: TextStyle(fontFamily: 'jost',color: Colors.black, fontSize: 14,fontWeight: FontWeight.w700),),),
                              ),

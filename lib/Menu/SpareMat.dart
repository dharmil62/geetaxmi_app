...
class SpareMat extends StatelessWidget {
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text("Request: Process Material",textAlign: TextAlign.center, style: TextStyle(
                   ...
                   makeInput(label: 'Description'),
                    ...
                    makeInput2(label: 'Eq Class :                           '),
                    Padding(
                      padding: EdgeInsets.all(10.0),
                    ),
                    Padding(padding: EdgeInsets.only(left: 20, right: 20),
                    child: Text("Note: You can raise request for equipment which are in operation and requires material for maintenance i.e. Grease, Oil, Fevi Quick. Minor spares for which you don't want to declare equipment as breakdown.", style: TextStyle(
                            ...
                            child: InkWell(
                              onTap: (){
                                Fluttertoast.showToast(
                                  msg: "You have successfully raised Spares Material Request.",
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text("Spare Mat Request",textAlign: TextAlign.center, style: TextStyle(

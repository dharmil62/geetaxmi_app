                ...
                child: Column(
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text("Performed additional duty", style: TextStyle(
                        fontSize: 15,
                      ...
                      child: Table(
                          ...
                          children: [
                            TableRow(children :[
                              ...
                              Padding(
                                padding: EdgeInsets.only(top: 20, bottom: 20),
                                child: Center(child: Text('Shift',style: TextStyle(fontFamily: 'jost',color: Colors.black, fontSize: 16,fontWeight: FontWeight.w700),),),
                              ),
                              Padding(
                                padding: EdgeInsets.only(top: 20, bottom: 20, right: 10, left: 20),
                                child: Center(child: Text('Over Time Shift',style: TextStyle(fontFamily: 'jost',color: Colors.black, fontSize: 16,fontWeight: FontWeight.w700),),),
                              ),
                              Padding(
                                padding: EdgeInsets.only(top: 20, bottom: 20, right: 5, left: 15),
                                child: Center(child: Text('Punch in Time',style: TextStyle(fontFamily: 'jost',color: Colors.black, fontSize: 16,fontWeight: FontWeight.w700),),),
                              ),
                              Padding(
                                padding: EdgeInsets.only(top: 20, bottom: 20, right: 5, left: 15),
                                child: Center(child: Text('Punch out Time',style: TextStyle(fontFamily: 'jost',color: Colors.black, fontSize: 16,fontWeight: FontWeight.w700),),),
                              ),
                            ]),
                            TableRow(children :[
                              Padding(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text("Available Over Time",

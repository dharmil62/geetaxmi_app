              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    makeInput2(label:"Break Down Area"),
                    Padding(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text("Breakdown",textAlign: TextAlign.center, style: TextStyle(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text("Validation",textAlign: TextAlign.center, style: TextStyle(
                                    fontWeight: FontWeight.w400,
                                    fontSize: 15, fontFamily: 'jost', color: Colors.white,
                                  ),),
                                ),

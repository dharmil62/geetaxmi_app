...
class Insdate extends StatelessWidget {
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    makeInput(label:"Insu. due Date :                "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput(label:"RTO due Date :                 "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput(label:"Fitness due Date :           "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput(label:"PUC due Date :                "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    const Divider(

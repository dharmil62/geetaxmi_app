              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    makeInput2(label:"Area :                   "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput2(label:"Sub Area :           "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput2(label:"Activity :              "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput2(label:"Sub Activity :      "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput2(label:"PRD Material :    "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput2(label:"Bench :                "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput2(label:"Unload Bench :  "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput2(label:"Primary Eq. :      "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    makeInput2(label:"Sec Eq. :             "),
                    Padding(
                      padding: EdgeInsets.all(5.0),
                    ),
                    const Divider(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text("Modify",textAlign: TextAlign.center, style: TextStyle(

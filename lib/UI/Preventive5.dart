...
import 'package:geetaxmi_app/UI/Preventive4.dart';
...
class Preventive5 extends StatelessWidget {
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text("You have successfully Released Vehicle for Preventive Maintenance.", style: TextStyle(
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 30, right: 30),
                      child: Text("Wait at designated area till further Eq. is allotted to you. You will be intimated through SMS for new Eq. assignment.", style: TextStyle(
                        fontWeight: FontWeight.w600,
                        fontSize: 14, fontFamily: 'jost', color: Colors.black,
                      ),),
                    ),

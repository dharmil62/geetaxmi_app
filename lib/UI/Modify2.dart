...
class Modify2 extends StatelessWidget {
                            ...
                            child: InkWell(
                              onTap: (){
                                Fluttertoast.showToast(
                                  msg: "You have successfully Modified your Work",
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text("Modify Work",textAlign: TextAlign.center, style: TextStyle(
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: InkWell(
                              onTap: (){
                                Fluttertoast.showToast(
                                  msg: "Enter proper performance measures in reading for some * field",
                                  toastLength: Toast.LENGTH_SHORT,
                                  gravity: ToastGravity.BOTTOM,
                                  timeInSecForIos: 2,
                                  backgroundColor: Colors.blueGrey,
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text("Fail",textAlign: TextAlign.center, style: TextStyle(
                                    fontWeight: FontWeight.w400,
                                    fontSize: 15, fontFamily: 'jost', color: Colors.white,
                                  ),),
                                ),
